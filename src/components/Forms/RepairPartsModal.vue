  ...
  <div class="repair-parts-modal">
    <div class="form-container">
      ...
      <div class="form-info" v-show="!isError && !isSuccess">
        <p class="form-title">Заявка на ремонт узла (агрегата)</p>
        ...
        <input
          class="form-input"
          type="text"
          placeholder="Наименование узла (агрегата)*"
...
@Options({
  ...
  methods: {
    sendRequest() {
      ...
      fetch("http://31.128.39.64:8000/api/requests-service-parts/", {
        method: "POST",
        headers: {
...
export default class RepairPartsModal extends Vue {}
</script>
<style>
.repair-parts-modal {
  position: fixed;
...
@media (max-width: 1600px) {
  .repair-parts-modal .form-container .form-info .form-input {
    margin-top: 1rem;
  }
}
