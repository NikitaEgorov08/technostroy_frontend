  ...
  <div class="repair-price-modal">
    <div class="form-container">
      ...
      <div class="form-info" v-show="!isError && !isSuccess">
        <p class="form-title">Запрос цены на: {{ product_title }}</p>
...
@Options({
  ...
  methods: {
    sendRequest() {
      ...
      if (this.type === "tech") {
        fetch("https://chelstroymash.ru/api/requests-tech/", {
          method: "POST",
          headers: {
...
export default class RepairPriceModal extends Vue {}
</script>
<style>
.repair-price-modal {
  position: fixed;
...
@media (max-width: 1600px) {
  .repair-price-modal .form-container .form-info .form-input {
    margin-top: 1rem;
  }
}
